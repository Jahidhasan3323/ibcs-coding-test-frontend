    ...
    <form class="auth-form"  @submit.prevent="login()">
      ...
      <div class="form-group">
        <div class="form-label-group">
          <input v-model="form.email" type="text" id="inputUser" class="form-control" placeholder="Username" autofocus=""> <label
      ...
      <div class="form-group">
        <div class="form-label-group">
          <input v-model="form.password" type="password" id="inputPassword" class="form-control" placeholder="Password"> <label
